...
@Component({
	...
	template: `
		...
		<div>
		  ...
		  <p>Congratulations my friend. You have enough money to retire in style. You will enjoy life with your fortune of {{player.duckets | number:'1.0-0'}} duckets, recounting your glory days.</p>
